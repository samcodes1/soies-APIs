...
public class StudentService {
    ...
    public Map<String, Object> getStudentDetailsForTeacher(Long teacherId, String term, String grade, String section, int page, int size) {
        ...
        try {
            // Fetch the teacher's record to retrieve campus name and other information
            ...
            // If no specific section assignment is found, allow fetching data based on campus, grade, and section
            ...
            // Fetch students for the specified campus, grade, and section with pagination
            Pageable pageable = PageRequest.of(page, size);
            ...
            // Populate response with student details and pagination info
            ...
            // Handle any exceptions and return an empty list and zero pagination values
